...
const InputOTP = ({
  ...
  return (
    <div className="flex flex-col items-center space-y-8">
      ...
      >
        Enter the liquid verification code
      </motion.p>
    </div>
  );
};
...
const OtpField_38 = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-sky-950 to-gray-900 relative overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_120%,rgba(56,189,248,0.1),rgba(0,0,0,0))]" />
