      ...
      >
        <div className="p-8">
              ...
              {(status || showSuccess) && (
                <motion.div 
                  className={`mt-4 text-sm text-center ${
                    showSuccess ? 'text-indigo-600' : 'text-purple-600'
                  }`}
                  initial={{ opacity: 0, y: -10 }}
                  animate={{ opacity: 1, y: 0 }}
                  exit={{ opacity: 0, y: -10 }}
          ...
          <div className="flex flex-col items-center">
            <button 
              className="w-full py-3 px-4 bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white font-medium rounded-lg transition-all duration-300 mb-4"
