...
const InputOTP = ({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-sky-50 flex flex-col items-center justify-center p-6">
      <motion.div 
      ...
      >
        <div className="p-8">
          <div className="text-center mb-8">
            <motion.div 
              className="w-20 h-20 bg-gradient-to-r from-blue-400 to-sky-500 rounded-2xl flex items-center justify-center mx-auto mb-4"
          ...
          <div className="mb-8">
            ...
            <AnimatePresence>
              {invalidIndexes.length > 0 && (
                <motion.div 
                  className="mt-4 text-yellow-600 text-sm text-center"
              ...
              {(status || showSuccess) && (
                <motion.div 
                  className={`mt-4 text-sm text-center ${
                    showSuccess ? 'text-blue-600' : 'text-sky-600'
                  }`}
                  initial={{ opacity: 0, y: -10 }}
                  animate={{ opacity: 1, y: 0 }}
                  exit={{ opacity: 0, y: -10 }}
          ...
          <div className="flex flex-col items-center">
            <button 
              className="w-full py-3 px-4 bg-gradient-to-r from-blue-400 to-sky-500 hover:from-blue-500 hover:to-sky-600 text-white font-medium rounded-lg transition-all duration-300 mb-4"
