...
const StepsRoot = ({
  ...
  const StepsItem = ({ isActive, isCompleted, children }) => (
    ...
    >
      <motion.div
        className={`flex items-center justify-center w-12 h-12 rounded-full text-white font-semibold shadow-lg ${
          isCompleted
            ? 'bg-green-600'
            : isActive
            ? 'bg-blue-600'
  ...
  return (
    <div className="flex flex-col items-center space-y-12 p-8 w-full max-w-4xl mx-auto">
