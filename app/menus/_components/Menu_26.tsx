...
export function Menu_26({ items, className = "" }: MenuProps) {
  return (
    <nav className={`p-4 bg-gradient-to-br from-pink-500 via-red-500 to-yellow-500 rounded-2xl ${className}`}>
