...
export function Menu_14({ items, className = "" }: MenuProps) {
  return (
    <nav className={`p-4 bg-gradient-to-br from-cyan-500 to-blue-500 rounded-2xl ${className}`}>
