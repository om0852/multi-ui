...
export function Menu_19({ items, className = "" }: MenuProps) {
  return (
    <nav className={`p-4 bg-gradient-to-br from-lime-400 to-emerald-500 rounded-2xl ${className}`}>
