...
export function Menu_11({ items, className = "" }: MenuProps) {
  return (
    <nav className={`p-4 bg-gradient-to-br from-violet-500 to-purple-500 rounded-2xl ${className}`}>
