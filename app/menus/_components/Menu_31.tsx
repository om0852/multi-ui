...
export function Menu_31({ items, className = "" }: MenuProps) {
  return (
    <nav className={`p-4 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl ${className}`}>
