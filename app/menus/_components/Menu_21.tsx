...
export function Menu_21({ items, className = "" }: MenuProps) {
  return (
    <nav className={`p-4 bg-gradient-to-br from-purple-600 to-indigo-600 rounded-2xl ${className}`}>
