...
export function Menu_29({ items, className = "" }: MenuProps) {
  return (
    <nav className={`p-4 bg-gradient-to-br from-red-500 to-pink-500 rounded-2xl ${className}`}>
