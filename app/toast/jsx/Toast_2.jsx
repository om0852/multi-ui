...
const Toast_2 = ({
  ...
  return (
    <motion.div
      ...
      animate="visible"
      exit="exit"
      variants={animationVariants[animationType ?? "bounce"]}
    ...
    >
      ...
      {/* Message */}
      <div className={clsx("flex-1 text-center text-base font-medium", textColor[theme ?? "dark"])}>
        {message}
      </div>
      ...
      >
        <svg
          ...
          strokeWidth={1.5}
          stroke="currentColor"
          className={clsx("w-6 h-6", closeIconColors[theme ?? "dark"])}
        >
