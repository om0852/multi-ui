const SegmentedCircularProgressBar = ({
  progress,
  size = 120,
  strokeWidth = 8,
  segmentColor = "#4A90E2",
  ...
  const renderSegments = () => {
    ...
    const segmentLength = radius * 0.7; // Length of each segment
    ...
    for (let i = 0; i < segments; i++) {
      ...
      const x1 = centerX + (radius - segmentLength) * Math.cos(startAngle + segmentAngle / 2);
      const y1 = centerY + (radius - segmentLength) * Math.sin(startAngle + segmentAngle / 2);
      const x2 = centerX + radius * Math.cos(startAngle + segmentAngle / 2);
      const y2 = centerY + radius * Math.sin(startAngle + segmentAngle / 2);
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-8">
        <h1 className="text-2xl font-bold text-gray-800 mb-2">Segmented Progress</h1>
        <p className="text-gray-600 mb-8">Discrete segments showing progress</p>
...
const SegmentedCircularProgressBarDemo = () => {
  ...
  const handleAnimationStart = () => {
    console.log("Segmented animation started");
  };
  
  const handleAnimationComplete = () => {
    console.log("Segmented animation completed");
  };
...
render(<SegmentedCircularProgressBarDemo />);
