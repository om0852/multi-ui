        ...
        <div className="main">
          <div className="up">
            <button className="card1">
              <svg height={90} width={90} viewBox="-40 0 180 90">
            ...
            <button className="card2">
              <svg height={90} width={90} viewBox="-30 -30 120 90">
          ...
          <div className="down">
            <button className="card3">
              <svg width={90} height={90} viewBox="-35 5 100 50">
            ...
            <button className="card4">
              <svg width={90} height={90} viewBox="-300 0 1312 530">
