...
const TabsList: React.FC<TabsListProps> = ({ children, activeTab, setActiveTab, className = "" }) => {
  return (
    <div className={`inline-flex p-4 bg-gradient-to-br from-red-950/40 via-orange-950/40 to-yellow-950/40 backdrop-blur-xl rounded-2xl border border-red-400/20 shadow-[0_8px_32px_rgba(248,113,113,0.2)] ${className}`}>
