...
const PasswordInput = ({
  ...
  return (
    <div className={`max-w-md mx-auto p-6 rounded-2xl bg-white dark:bg-gray-800 shadow-xl ${className}`}>
        ...
        <div className="space-y-6">
          ...
          <div>
            <motion.button
              ...
              whileHover={!isSubmitting && allRequirementsMet && touched ? { scale: 1.01 } : {}}
              whileTap={!isSubmitting && allRequirementsMet && touched ? { scale: 0.99 } : {}}
            >
              {isSubmitting ? (
