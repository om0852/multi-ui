    ...
    <div className={`w-full ${className}`}>
      ...
      >
        <input
          ...
          className={`peer w-full py-2 bg-transparent text-gray-900 dark:text-gray-100 focus:outline-none placeholder-gray-500 dark:placeholder-gray-400 ${inputClassName}`}
      ...
      {error && (
        <motion.span
          className={`block mt-1 text-xs ${errorClassName}`}
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        >
          {error}
...
const PasswordDemo = () => {
  ...
  return (
    <div className="max-w-md mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
      <h2 className="text-xl font-semibold mb-4 text-gray-800 dark:text-white">Create Account</h2>
