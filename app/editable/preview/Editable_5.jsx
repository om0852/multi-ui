...
function RichTextEditableContainer({ 
  initialContent = '<p>Click the edit button to modify this <strong>rich text</strong> content...</p>', 
  className = '' 
}) {
    ...
    >
      <AnimatePresence mode="wait">
        {isEditing ? (
          ...
          >
            ...
            <div
              ...
              className="prose dark:prose-invert max-w-none mb-2 p-2 border-2 border-blue-300 dark:border-blue-600 
                ...
                bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-200 min-h-[100px]"
            />
          ...
          >
            <div
              className="prose dark:prose-invert max-w-none text-gray-800 dark:text-gray-200 min-h-[100px]"
              dangerouslySetInnerHTML={{ __html: content }}
            />
            <motion.button
              whileHover={{ scale: 1.05 }}
...
render(<RichTextEditableContainer />);
