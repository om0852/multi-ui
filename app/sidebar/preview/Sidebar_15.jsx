const { HiHome, HiUser, HiCog, HiMail, HiBell, HiSearch, HiHeart, HiSun } = ReactIcons;
        ...
        >
          <div className="relative flex items-center">
            <div className="w-10 h-10 rounded-full bg-emerald-200 dark:bg-emerald-700 flex items-center justify-center">
              <HiUser className="w-6 h-6 text-emerald-700 dark:text-emerald-300" />
            </div>
            {isExpanded && (
              <div className="ml-3">
                <p className="text-sm font-medium text-emerald-900 dark:text-emerald-100">John Doe</p>
                <p className="text-xs text-emerald-600 dark:text-emerald-400">Free Plan</p>
              </div>
            )}
          </div>
        </motion.div>
