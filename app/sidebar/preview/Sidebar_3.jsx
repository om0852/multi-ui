  ...
  return (
    <div className="flex min-h-screen bg-gray-100 dark:bg-gray-900">
        ...
        <div className="flex flex-col justify-between flex-1 mt-6">
          ...
          <div className="mt-6">
            <div className="p-3 bg-gray-100 rounded-lg dark:bg-gray-800">
              ...
              <img className="object-cover w-full h-32 mt-2 rounded-lg" src="https://images.unsplash.com/photo-1658953229664-e8d5ebd039ba?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1374&h=1374&q=80" alt="Feature preview"/>
            </div>

            <div className="flex items-center justify-between mt-6">
              <a href="#" className="flex items-center gap-x-2">
                <img className="object-cover rounded-full h-7 w-7" src="https://images.unsplash.com/photo-1531427186611-ecfd6d936c79?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=634&h=634&q=80" alt="User avatar" />
      ...
      <main className="flex-1 p-6">
        ...
        <p className="mt-2 text-gray-600 dark:text-gray-300">Welcome back, John!</p>
      </main>
    </div>
  );
};
