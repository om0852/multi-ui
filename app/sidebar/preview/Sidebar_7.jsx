    ...
    <div className="flex min-h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <div className="flex flex-col items-center w-16 h-screen py-8 bg-white dark:bg-gray-900 dark:border-gray-700">
        <nav className="flex flex-col items-center flex-1 space-y-8">
          ...
          <button 
            ...
            className={`p-1.5 inline-block transition-colors duration-200 rounded-lg focus:outline-none ${
              activeTab === 'home' 
      ...
      <main className="flex-1 p-6">
        ...
        <p className="mt-2 text-gray-600 dark:text-gray-300">
          {activeTab === 'home' && 'Welcome to your dashboard. Here\'s what\'s happening with your accounts.'}
