    ...
    <div className="flex min-h-screen bg-gray-100 dark:bg-gray-900">
      <aside className="flex flex-col w-64 h-screen px-4 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
        ...
        <div className="flex flex-col items-center mt-6 -mx-2">
          <img className="object-cover w-24 h-24 mx-2 rounded-full" src="https://images.unsplash.com/photo-1531427186611-ecfd6d936c79?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=634&q=80" alt="User avatar"/>
      ...
      <main className="flex-1 p-6">
        <h1 className="text-2xl font-semibold text-gray-800 dark:text-white">Welcome back, John!</h1>
